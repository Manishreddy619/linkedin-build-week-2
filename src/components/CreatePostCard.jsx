					...
					<Col md={6}>
						<Container className='createPost d-flex flex-column pt-2 pb-3'>
							<div className='d-flex'>
								...
								<button
									className='start-post flex-grow-1 text-left pl-3'
									onClick={handleShow}>
									Start a post
								</button>
							</div>
							...
							<div className='d-flex justify-content-between'>
								...
								<button className='share-card-button'>
									<HiOutlinePhotograph className='post-card-icon' />
									<span class='text-muted'>Write article</span>
								</button>
							</div>
						</Container>
					</Col>
			...
			<Modal show={show} onHide={handleClose}>
				...
				<Modal.Body>
					<div>
						...
						<button className='post-dropdown mx-1 dropdown-toggle'>
							<GiPerson />
							Christian Ankobil
						</button>
						<button className='post-dropdown mx-1 dropdown-toggle'>
					...
					<button className='add-hashtag mb-3'>
					...
					<div className='d-flex'>
						...
						<div>
							<button className='anyone-button'>
								<BiMessageRoundedDetail className='share-icons' />
								Anyone
							</button>
						</div>
						<div>
							<button className='post-button px-3 py-1 ml-5'>
								<span>Post</span>
							</button>
						</div>
					</div>
